...
5. Run in terminal `gulp open-app` for opening the Presentation Page (default) of the product. You can set in `gulpfile.js` file from your downloaded archive any page you want to open in browser, at line 30: `gulp.src('./presentation.html')`
